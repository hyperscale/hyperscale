...
BOOST_AUTO_TEST_CASE(test_token) {
    ...
    BOOST_CHECK_EQUAL(tok.getStartOffset(), 0);
    BOOST_CHECK_EQUAL(tok.is(hyperscale::syntax::TokenKind::IntegerLiteral), true);
    BOOST_CHECK_EQUAL(tok.isNot(hyperscale::syntax::TokenKind::Identifier), true);
}
